...
tokens{
    COMMENT,STRING_BEGIN,STRING_CONTENT,STRING_END,ESCAPE
}
//----------------------------------------------------------------
// Basic Symbols
//----------------------------------------------------------------
...
STRING_BEGIN                : '"'                               -> pushMode(STRING_CONTENT_MODE),type(STRING_BEGIN);
...
FORMAT_STRING_BEGIN         : '"'                               -> pushMode(FORMAT_STRING_CONTENT_MODE),type(STRING_BEGIN);
...
TILDE_AMPERSAND             : '~&';
TILDE_D                     : '~' DIGIT* 'd';
ESCAPE_FORMATED_SEQUENCE    : '\\' .                            ->type(ESCAPE);
FORMAT_STRING_CONTENT       : ~["\\~]+                          ->type(STRING_CONTENT);
FORMAT_STRING_END           : '"'                               -> popMode, popMode,type(STRING_END);

mode STRING_CONTENT_MODE;
ESCAPE_SEQUENCE             : '\\' .                            ->type(ESCAPE);
STRING_CONTENT              : ~["\\]+                           ->type(STRING_CONTENT);
STRING_END                  : '"'                               -> popMode,type(STRING_END);