...
public class LispLexer extends Lexer {
	...
	public static final int
		COMMENT_MODE=1, STRING_FORMAT_MODE=2, FORMAT_STRING_CONTENT_MODE=3;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DIFFERENT", "NUMBERDEF", "ID", "STRINGDEF", "ELEMENTTYPE", "INTIALELEMENT", 
			"INTIALCONTENT", "ADJUSTABLE", "FILLPOINTER", "TYPEST", "READONLY", "DIGIT", 
			"LETTER", "INTEGERNUMBERDEF", "FLOATNUMBERDEF", "SCIENCENUMBERDEF", "COLON", 
			"MULTILINE_COMMENT", "SINGLELINECOMMENT", "FORMAT_DESTINATION", "FORMAT_STRING_BEGIN", 
			"TILDE_F", "TILDE_A", "TILDE_S", "TILDE_PERCENT", "TILDE_AMPERSAND", 
			"TILDE_D", "FORMAT_STRING_CONTENT", "FORMAT_STRING_END"
		};
	}
