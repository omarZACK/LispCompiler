...
public class LispLexer extends Lexer {
	...
	public static final int
		COMMENT_MODE=1, STRING_FORMAT_MODE=2, FORMAT_STRING_CONTENT_MODE=3, STRING_CONTENT_MODE=4;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "COMMENT_MODE", "STRING_FORMAT_MODE", "FORMAT_STRING_CONTENT_MODE", 
		"STRING_CONTENT_MODE"
	};
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"WS", "COMMENT_START", "MULTILINE_COMMENT_START", "TRUE", "FALSE", "PLUS", 
			"MINUS", "MULTIPLY", "DIVIDE", "NUMEQUAL", "EQUAL", "LT", "GT", "LTE", 
			"GTE", "AND", "OR", "NOT", "MIN", "MAX", "INCF", "DECF", "LOGAND", "LOGIOR", 
			"LOGXOR", "LOGNOR", "LOGEQV", "EVEN", "ODD", "ZERO", "BOUND", "TYPE", 
			"COND", "IF", "WHEN", "UNLESS", "CASE", "OTHERWISE", "DOLIST", "DOTIMES", 
			"LOOP", "FOR", "DO_LOOP", "BLOCK", "RETURN", "RETURN_FROM", "IN", "FROM", 
			"TO", "BY", "ERROR", "FUNCALL", "APPLY", "MAPCAR", "LAMBDA", "VECTOR", 
			"CHARACTER", "ARRAY", "MARCO", "SETQ", "FUNCTION", "STRUCT", "PRINT", 
			"PRIN1", "PRINC", "DEFPARAM", "VARIABLE", "WRITE", "FORMAT", "LET", "PROGN", 
			"CONSTANT", "LIST", "CONS", "FIXNUM", "CHARLESSP", "STRINGLESSP", "STRING", 
			"BIGNUM", "NUMBER", "REAL", "INTEGER", "RATION", "FLOAT", "COMPLEX", 
			...
			"DIFFERENT", "ELEMENTTYPE", "INTIALELEMENT", "INTIALCONTENT", "ADJUSTABLE", 
			"FILLPOINTER", "TYPEST", "READONLY", "NUMBERDEF", "ID", "STRING_BEGIN", 
			"DIGIT", "LETTER", "INTEGERNUMBERDEF", "FLOATNUMBERDEF", "SCIENCENUMBERDEF", 
			"COLON", "MULTILINE_COMMENT", "SINGLELINECOMMENT", "FORMAT_DESTINATION", 
			"FORMAT_STRING_BEGIN", "TILDE_F", "TILDE_A", "TILDE_S", "TILDE_PERCENT", 
			"TILDE_AMPERSAND", "TILDE_D", "ESCAPE_FORMATED_SEQUENCE", "FORMAT_STRING_CONTENT", 
			"FORMAT_STRING_END", "ESCAPE_SEQUENCE", "STRING_CONTENT", "STRING_END"
		};
	}
