...
format_string
     : FORMAT_STRING_BEGIN (FORMAT_STRING_CONTENT |string_format_argument)* FORMAT_STRING_END  # FORMAT_STRING
     ;
...
reverse_expression
    : REVERSE (listForm|STRINGDEF)                     # REVERSE_EXPRESSION
    ;

character_function_expression
    : CHARACTER STRINGDEF NUMBERDEF                    # CHARACTER_FUNCTION_EXPRESSION
    ;

sort_expression
    : SORT (ID|listForm|STRINGDEF) hashcomparison      # SORT_EXPRESSION
    ;
